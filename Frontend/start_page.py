...
class startPage(QWidget):
    ...
    def new_project_ok(self):
        ...
        globals.current_session.companies.append(Company(list_id=0,name="VW",field_of_study=[field_etech,field_masch,field_inf]))
        globals.current_session.companies.append(Company(list_id=1,name="Ferchau",field_of_study=[field_etech,field_masch,field_inf,field_wirtschaft]))
        globals.current_session.companies.append(Company(list_id=2,name="Airbus",field_of_study=[field_masch]))
        globals.current_session.companies.append(Company(list_id=3,name="Infenion",field_of_study=[field_etech,field_inf]))
